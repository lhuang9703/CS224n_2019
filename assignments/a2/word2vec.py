...
def naiveSoftmaxLossAndGradient(
    ...
    delta_value = y_hat.copy()
    delta_value[outsideWordIdx] -= 1
    gradCenterVec = outsideVectors.T.dot(delta_value)
    gradOutsideVecs = np.dot(delta_value[:, np.newaxis], centerWordVec[np.newaxis, :])
